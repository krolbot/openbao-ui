...
| **4** ◑ | Access mgmt | D, E | Auth methods enable/disable + userpass/AppRole config (role-id/secret-id), identity entities + groups. Remaining: per-method config for ldap/oidc/k8s/cert, MFA |
